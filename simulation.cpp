...
{
    cout << "\n-----------------------------------------------\n\n";
    cout << "Extra Credit: We prompt user for game input." << endl;
    cout << "\n-----------------------------------------------\n\n";
...
/*******************************************************************************
** Description: The displayBoard function loops through the board, printing an
** empty space if position is null, or if a critter occupies the position,
